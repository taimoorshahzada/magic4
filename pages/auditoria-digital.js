                  ...
                  <div className="container">
                      <div className="main-header-inner" style={{overflow:"hidden"}}>
                          <div className="main-header-title" style={{overflow:"hidden"}}>
                              <h1 className='animate__animated animate__fadeInUp animate__delay-5ms animate__slow' style={{overflow:"hidden"}}>Auditoría digital</h1>
                          </div>
                      </div>
                  </div>
              </div>
                                      ...
                                      <div className="case-right">
                                          <div className="case-right-inner">
                                              <div className="case-content">
                                                  <div className="section-desc">
                                                      <p>Auditamos la app de SoloPerformance con el objetivo de hacerla más accesible. Esto redujo la curva de aprendizaje de la plataforma.</p>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
                      ...
                      <div className="services-inner">
                          ...
                          <div className="services-box-outer">
                              <ul>
                                  ...
                                  <li><a href="#">Analítica de perfiles sociales</a></li>
