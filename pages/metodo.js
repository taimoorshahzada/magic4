                  ...
                  <div className="container">
                      <div className="main-header-inner" style={{overflow:"hidden"}}>
                            <div className="main-header-title" style={{overflow:"hidden"}}>
                                <h1 className='animate__animated animate__fadeInUp animate__delay-5ms animate__slow' style={{overflow:"hidden"}}>Método de trabajo</h1>
                            </div>
                        </div>
                  </div>
              </div>
                  ...
                  <div className="container">
                      <div className="case-studies-inner">
                          <div className="case-studies-img">
                              <img src="/images/img-metodo.png" className="img-fluid" alt=""/>
                          </div>
                                      ...
                                      <div className="case-right">
                                          <div className="case-right-inner">
                                              <div className="case-content">
                                                  <div className="section-desc">
                                                      <p>Nuestra metodología está enfoada en poner en valor lo que te hace diferente. Nuestro equipo te acompañará durante todo el proceso, porque para nosotros, que vivas una experiencia positiva y disfrutes creando tu proyecto digital, es primoridial.
                                                          <br/>
                                                          <br/>
                                                      Una metodología basada en muchos cafés y charlas, rigurosidad, buen diseño y resultados. Bienvenidos a Bla. </p>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
