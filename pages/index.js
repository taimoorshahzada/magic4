...
export default function Home() {
	...
	function startAnimation() {
		...
		animateUpTexts[animateUpTexts.length - 1].style.animationName = 'lastMoveup';
		...
		animateUpTexts[animateUpTexts.length - 1].style.animationFillMode = 'forwards';
	}
	...
	useEffect(() => {
		...
		setTimeout(function() {
			$('.topcontainer').addClass('animate__animated animate__fadeOutUp animate__delay-10ms animate__slow');
			$('.topcontainer').addClass('animate__animated animate__fadeOutUp animate__delay-10ms animate__slow');
		}, 1400);
		setTimeout(function() {
			...
			$('.body').addClass('animate__animated animate__fadeInUp animate__delay-7ms animate__slow');
			// $('.header-inner').addClass('animate__animated animate__fadeInUp animate__delay-10ms animate__slow');

			$('.barcode-inner').addClass('animate__animated animate__fadeInUp animate__delay-10ms animate__slow');
			$('#3d-section').addClass('animate__animated animate__fadeInUp animate__delay-10ms animate__slow');
			$('.border-bottoms').show();
		...
		setTimeout(function() {
			...
			$('.logo').addClass('animate__animated animate__fadeInUp animate__delay-10ms animate__slow');
			$('.header-menu-btn').addClass('animate__animated animate__fadeInUp animate__delay-10ms animate__slow');
	...
	function getScroll() {
		...
		$(window).on('scroll', function() {
			if ($('.gallery-section').isInViewport()) {
				...
				$('.gallery-section .cols-even').css('transform', 'translateY(-' + change + '%)');
				$('.gallery-section .cols-odd').css('transform', 'translateY(' + change + '%)');
	...
	return (
		<div className="main-page">
			...
			<main>
				...
				<div className="gallery-section" id="3d-section" style={{ height: '0px' }} />
