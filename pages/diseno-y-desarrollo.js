                  ...
                  <div className="container">
                      <div className="main-header-inner " style={{overflow:"hidden"}}>
                          <div className="main-header-title" style={{overflow:"hidden"}}>
                              <h1 className='animate__animated animate__fadeInUp animate__delay-5ms animate__slow' style={{overflow:"hidden"}}>Diseño y <span>{`{desarrollo}`}</span> </h1>
                          </div>
                          <div className="main-header-title" style={{overflow:"hidden"}}>
                                      ...
                                      <div className="barcode-right-inner">
                                          <div className="barcode-content">
                                              <div className="section-desc">
                                                  <p>Llevamos al siguente nivel tus conceptos. Con la accesibilidad y la experiencia de usuario como pilares, diseñamos y desarrollamos tus ideas usando la mejor tecnología.</p>
                                      ...
                                      <div className="case-right">
                                          <div className="case-right-inner">
                                              <div className="case-content">
                                                  <div className="section-desc">
                                                      <p>El mayor software de gestion del rendimiento físico nos contrato para rediseñar parte de su plataforma y app, así como su landing web.</p>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
                  ...
                  <div className="container_">
                      <div className="services-inner">
                          ...
                          <div className="services-box-outer">
                              <ul>
                                  <li><a href="#">Diseño web y app</a></li>
                                  <li><a href="#">Desarrollo y programación</a></li>
